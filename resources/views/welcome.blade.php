    ...
    <nav class="navbar navbar-top-default bottom-nav navbar-expand-lg navbar-gradient nav-icon">
        <div class="container">
            <a href="javascript:void(0)" title="Logo" class="logo scroll">
                <!--Logo Default-->
                <img src="images/logo-black.png" alt="logo" class="logo-dark default">
            </a>
    ...
    <div class="side-menu">
        <div class="inner-wrapper">
            ...
            <div class="side-footer text-white w-100">
                ...
                <p class="text-white">&copy; 2021 오산르네상스포럼</p>
            </div>
        </div>
    </div>
        ...
        <div id="rev_slider_19_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
            <ul>    <!-- SLIDE  -->
                <li data-index="rs-94" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="images/bg-minimal.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
    ...
    <div class="container">
        ...
        <div class="row wow fadeIn">
            <div class="col-md-12 text-center">
                <div class="title d-inline-block">
                    ...
                    <p> 인생이란 바로 곁에 있는 소중한 사람들과 함께 더불어 살아가는 아름다운 동행이라는 뜻입니다.<br />
                     주변 사람들과 함께 걷기도 하고, 지칠 때는 서로를 위로하고 응원하며 함께 걷기도 하고 지칠 때는 서로를 위로 하고 응원하며 또 힘을 내어 달리기도 하지요.
                     <br /> 결국 완주하는 마라톤과 같은 것이 우리의 인생이라고 생각합니다.<br /><br />
        ...
        <div class="row align-items-center wow fadeIn">
            ...
            <div class="col-md-6 mb-4">
                    <p>오산르네상스 포럼은 깨끗하고 안전한 도시의 아동 청소년들이 꿈꾸는 문화 창조도시를 만들어가기 위하여 창립한 비영리 단체로서
                       <br><br>
                        문화 예술, 도시환경, 교육복지, 자원봉사 등 다양한 활동을 통해 오산 시민들의 다양한 문화와 교육, 환경이 어우러진 사람이 행복한 문화 교육도시로 한 단계 도약할 수 있도록 오산 시민의 관심과 많은 참여 부탁드립니다. </p>
                </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                <div class="title">
                    <h6 class="third-color mb-3">오산르네상스 조직도</h6>
                    <h2 class="mb-4">오산르네상스 조직도<br></h2>
                    <p></p>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div id="team-slider" class="owl-carousel owl-theme wow fadeInUp">
                    ...
                    <div class="team-box item">
                        <!--Team Image-->
                        <div class="team-image">
                            <img src="images/team-img3.jpg" alt="image">
                            <!--Team Overlay-->
                            <div class="overlay center-block">
                                <!--Team Social-->
                                <ul class="team-social">
...
<section id="work" class="cube-portfolio1">
    <div class="container">
        ...
        <div id="js-filters-mosaic-flat" class="cbp-l-filters-button">
            ...
            <div data-filter="*" class="cbp-filter-item-active cbp-filter-item">모든 사진</div>
    ...
    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne"aria-expanded="false" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
                ...
                <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
                    <img src="images/2.png" width="100%" alt="image">
                </div>
                <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
                    <img src="images/3.png" width="100%" alt="image">
                </div>
                <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
                    <img src="images/4.png" width="100%" alt="image">
                </div>
                <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
                    <img src="images/5.png" width="100%" alt="image">
                </div>
                <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
                    <img src="images/6.png" width="100%" alt="image">
                </div>
                <div class="blog-detail-img col-sm-12 mb-5 hover-effect">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="company-about fadeIn">© 2021 오산르네상스포럼</p>
            </div>
        </div>
    </div>
</section>
